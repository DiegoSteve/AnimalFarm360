class AnimalsController < ApplicationController
  ...
  private
    ...
    def animal_params
      params.require(:animal).permit(:species, :breed, :birthdate, :initial_weight, :gender, :status, :acquisition_date, :supplier, :health_history, :production, :comments, :corral_id, :ranch_id)
    end
end
